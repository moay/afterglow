...
(function (f) { if (typeof exports === 'object' && typeof module !== 'undefined') { module.exports = f(); } else if (typeof define === 'function' && define.amd) { define([], f); } else { let g; if (typeof window !== 'undefined') { g = window; } else if (typeof global !== 'undefined') { g = global; } else if (typeof self !== 'undefined') { g = self; } else { g = this; }g.videojs = f(); } }(() => {
  let define; let module; let exports; return (function e(t, n, r) { function s(o, u) { if (!n[o]) { if (!t[o]) { const a = typeof require === 'function' && require; if (!u && a) return a(o, !0); if (i) return i(o, !0); const f = new Error(`Cannot find module '${o}'`); throw f.code = 'MODULE_NOT_FOUND', f; } const l = n[o] = { exports: {} }; t[o][0].call(l.exports, (e) => { const n = t[o][1][e]; return s(n || e); }, l, l.exports, e, t, n, r); } return n[o].exports; } var i = typeof require === 'function' && require; for (let o = 0; o < r.length; o++)s(r[o]); return s; }({
    1: [function (_dereq_, module, exports) {
      ...
      const _button = _dereq_(2);

      const _button2 = _interopRequireDefault(_button);

      const _component = _dereq_(5);
 ...
 * @class BigPlayButton
 */
      const BigPlayButton = (function (_Button) {
   ...
   */
    ...
    2: [function (_dereq_, module, exports) {
      ...
      const _clickableComponent = _dereq_(3);

      const _clickableComponent2 = _interopRequireDefault(_clickableComponent);

      const _component = _dereq_(5);

      const _component2 = _interopRequireDefault(_component);

      const _log = _dereq_(85);

      const _log2 = _interopRequireDefault(_log);

      const _object = _dereq_(136);
 ...
 * @class Button
 */
      const Button = (function (_ClickableComponent) {
   ...
   */
        ...
        Button.prototype.createEl = function createEl() {
          const tag = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'button';
          ...
          const el = _component2.default.prototype.createEl.call(this, tag, props, attributes);
   ...
   */
    ...
    3: [function (_dereq_, module, exports) {
      ...
      const _dom = _dereq_(80);

      const Dom = _interopRequireWildcard(_dom);

      const _events = _dereq_(81);

      const Events = _interopRequireWildcard(_events);

      const _fn = _dereq_(82);

      const Fn = _interopRequireWildcard(_fn);

      const _log = _dereq_(85);

      const _log2 = _interopRequireDefault(_log);

      const _document = _dereq_(92);
 ...
 */
      const ClickableComponent = (function (_Component) {
        _inherits(ClickableComponent, _Component);

        function ClickableComponent(player, options) {
          _classCallCheck(this, ClickableComponent);

          const _this = _possibleConstructorReturn(this, _Component.call(this, player, options));
   ...
   */
        ...
        ClickableComponent.prototype.createEl = function createEl() {
          const tag = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'div';
          let props = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
          let attributes = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
          ...
          const el = _Component.prototype.createEl.call(this, tag, props, attributes);
   ...
   */
        ...
        ClickableComponent.prototype.controlText = function controlText(text) {
          const el = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this.el();
 ...
 * @class CloseButton
 */
      const CloseButton = (function (_Button) {
        _inherits(CloseButton, _Button);

        function CloseButton(player, options) {
          _classCallCheck(this, CloseButton);

          const _this = _possibleConstructorReturn(this, _Button.call(this, player, options));
    ...
    5: [function (_dereq_, module, exports) {
      ...
      const _guid = _dereq_(84);

      const Guid = _interopRequireWildcard(_guid);
      ...
      const _toTitleCase = _dereq_(89);

      const _toTitleCase2 = _interopRequireDefault(_toTitleCase);

      const _mergeOptions = _dereq_(86);

      const _mergeOptions2 = _interopRequireDefault(_mergeOptions);
 ...
 */
   ...
   */
        ...
        Component.prototype.addChild = function addChild(child) {
          ...
          const index = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : this.children_.length;
          ...
          if (typeof child === 'string') {
            ...
            // (e.g. playButton)
            const componentClassName = options.componentClass || (0, _toTitleCase2.default)(componentName);
   ...
   */
        ...
        Component.prototype.initChildren = function initChildren() {
          ...
          if (children) {
            (function () {
              // `this` is `parent`
              const parentOptions = _this.options_;

              const handleAdd = function handleAdd(child) {
                ...
                // for each
                const newChild = _this.addChild(name, opts);
              ...
              // give us extra children we do not want. So, we want to filter them out.
                .concat(Object.keys(_this.options_).filter(child => !workingChildren.some((wchild) => {
                  ...
                  const c = Component.getComponent(child.opts.componentClass || (0, _toTitleCase2.default)(child.name));
        ...
        Component.prototype.on = function on(first, second, third) {
          ...
          if (typeof first === 'string' || Array.isArray(first)) {
            ...
            (function () {
              const target = first;
              const type = second;
              const fn = Fn.bind(_this2, third);

              // When this component is disposed, remove the listener from the other component
              const removeOnDispose = function removeOnDispose() {
              ...
              const cleanRemover = function cleanRemover() {
   ...
   */
        ...
        Component.prototype.ready = function ready(fn) {
          const sync = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
   ...
   */
        ...
        Component.prototype.currentDimension = function currentDimension(widthOrHeight) {
          ...
          if (typeof _window2.default.getComputedStyle === 'function') {
            const computedStyle = _window2.default.getComputedStyle(this.el_);

            computedWidthOrHeight = computedStyle.getPropertyValue(widthOrHeight) || computedStyle[widthOrHeight];
          } else if (this.el_.currentStyle) {
            // ie 8 doesn't support computed style, shim it
            // return clientWidth or clientHeight instead for better accuracy
            const rule = `offset${(0, _toTitleCase2.default)(widthOrHeight)}`;
   ...
   */
        ...
        Component.prototype.setTimeout = function setTimeout(fn, timeout) {
          ...
          const timeoutId = _window2.default.setTimeout(fn, timeout);

          const disposeFn = function disposeFn() {
   ...
   */
        ...
        Component.prototype.setInterval = function setInterval(fn, interval) {
          ...
          const intervalId = _window2.default.setInterval(fn, interval);
   ...
   */
    ...
    6: [function (_dereq_, module, exports) {
      ...
      const _trackButton = _dereq_(36);

      const _trackButton2 = _interopRequireDefault(_trackButton);

      const _component = _dereq_(5);

      const _component2 = _interopRequireDefault(_component);

      const _audioTrackMenuItem = _dereq_(7);

      const _audioTrackMenuItem2 = _interopRequireDefault(_audioTrackMenuItem);
 ...
 */
      const AudioTrackButton = (function (_TrackButton) {
        ...
        function AudioTrackButton(player) {
          ...
          const _this = _possibleConstructorReturn(this, _TrackButton.call(this, player, options));
 ...
 */
      const AudioTrackMenuItem = (function (_MenuItem) {
        ...
        function AudioTrackMenuItem(player, options) {
          ...
          const _this = _possibleConstructorReturn(this, _MenuItem.call(this, player, options));

          _this.track = track;

          if (tracks) {
            (function () {
              const changeHandler = Fn.bind(_this, _this.handleTracksChange);
 ...
 * @class ControlBar
 */
      const ControlBar = (function (_Component) {
 ...
 */
      const FullscreenToggle = (function (_Button) {
 ...
 * @class LiveDisplay
 */
      const LiveDisplay = (function (_Component) {
   ...
   */
        ...
        LiveDisplay.prototype.createEl = function createEl() {
          const el = _Component.prototype.createEl.call(this, 'div', {
 ...
 * @class MuteToggle
 */
      const MuteToggle = (function (_Button) {
 ...
 * @class PlayToggle
 */
      const PlayToggle = (function (_Button) {
   ...
   */
    ...
    13: [function (_dereq_, module, exports) {
      ...
      const _menuButton = _dereq_(47);

      const _menuButton2 = _interopRequireDefault(_menuButton);

      const _menu = _dereq_(49);

      const _menu2 = _interopRequireDefault(_menu);

      const _playbackRateMenuItem = _dereq_(14);

      const _playbackRateMenuItem2 = _interopRequireDefault(_playbackRateMenuItem);
 ...
 */
      const PlaybackRateMenuButton = (function (_MenuButton) {
        _inherits(PlaybackRateMenuButton, _MenuButton);

        function PlaybackRateMenuButton(player, options) {
          _classCallCheck(this, PlaybackRateMenuButton);

          const _this = _possibleConstructorReturn(this, _MenuButton.call(this, player, options));
   ...
   */
        ...
        PlaybackRateMenuButton.prototype.createMenu = function createMenu() {
          const menu = new _menu2.default(this.player());
 ...
 */
      const PlaybackRateMenuItem = (function (_MenuItem) {
 ...
 */
      const LoadProgressBar = (function (_Component) {
   ...
   */
        ...
        LoadProgressBar.prototype.update = function update() {
          ...
          const percentify = function percentify(time, end) {
            // no NaN
          ...
          for (let _i = children.length; _i > buffered.length; _i--) {
    ...
    16: [function (_dereq_, module, exports) {
      ...
      const _formatTime = _dereq_(83);

      const _formatTime2 = _interopRequireDefault(_formatTime);

      const _throttle = _dereq_(98);
 ...
 */
      const MouseTimeDisplay = (function (_Component) {
   ...
   */
        ...
        MouseTimeDisplay.prototype.update = function update(newTime, position) {
          const time = (0, _formatTime2.default)(newTime, this.player_.duration());
          ...
          if (this.keepTooltipsInside) {
            ...
            const tooltipWidth = parseFloat(_window2.default.getComputedStyle(this.tooltip).width);
   ...
   */
        ...
        MouseTimeDisplay.prototype.clampPosition_ = function clampPosition_(position) {
          ...
          const playerWidth = parseFloat(_window2.default.getComputedStyle(this.player().el()).width);
          const tooltipWidth = parseFloat(_window2.default.getComputedStyle(this.tooltip).width);
          const tooltipWidthHalf = tooltipWidth / 2;
 ...
 */
      const PlayProgressBar = (function (_Component) {
 ...
 */
      const ProgressControl = (function (_Component) {
 ...
 * @class SeekBar
 */
      const SeekBar = (function (_Slider) {
        _inherits(SeekBar, _Slider);

        function SeekBar(player, options) {
          _classCallCheck(this, SeekBar);

          const _this = _possibleConstructorReturn(this, _Slider.call(this, player, options));
   ...
   */
        ...
        SeekBar.prototype.updateProgress = function updateProgress() {
          ...
          if (this.keepTooltipsInside) {
            ...
            const playerWidth = parseFloat(_window2.default.getComputedStyle(this.player().el()).width);
            const tooltipWidth = parseFloat(_window2.default.getComputedStyle(this.tooltipProgressBar.tooltip).width);
 ...
 * @class PlayProgressBar
 */
      const TooltipProgressBar = (function (_Component) {
   ...
   */
        ...
        TooltipProgressBar.prototype.updateDataAttr = function updateDataAttr() {
          const time = this.player_.scrubbing() ? this.player_.getCache().currentTime : this.player_.currentTime();
          const formattedTime = (0, _formatTime2.default)(time, this.player_.duration());
    ...
    21: [function (_dereq_, module, exports) {
      ...
      const _spacer = _dereq_(22);

      const _spacer2 = _interopRequireDefault(_spacer);
 ...
 */
      const CustomControlSpacer = (function (_Spacer) {
   ...
   */
        ...
        CustomControlSpacer.prototype.createEl = function createEl() {
          const el = _Spacer.prototype.createEl.call(this, {
            className: this.buildCSSClass(),
          });
 ...
 * @class Spacer
 */
      const Spacer = (function (_Component) {
   ...
   */
    ...
    23: [function (_dereq_, module, exports) {
      ...
      const _textTrackMenuItem = _dereq_(31);

      const _textTrackMenuItem2 = _interopRequireDefault(_textTrackMenuItem);
 ...
 */
      const CaptionSettingsMenuItem = (function (_TextTrackMenuItem) {
        ...
        function CaptionSettingsMenuItem(player, options) {
          ...
          const _this = _possibleConstructorReturn(this, _TextTrackMenuItem.call(this, player, options));
   ...
   */
    ...
    24: [function (_dereq_, module, exports) {
      ...
      const _textTrackButton = _dereq_(30);

      const _textTrackButton2 = _interopRequireDefault(_textTrackButton);

      const _component = _dereq_(5);

      const _component2 = _interopRequireDefault(_component);

      const _captionSettingsMenuItem = _dereq_(23);

      const _captionSettingsMenuItem2 = _interopRequireDefault(_captionSettingsMenuItem);
 ...
 */
      const CaptionsButton = (function (_TextTrackButton) {
        _inherits(CaptionsButton, _TextTrackButton);

        function CaptionsButton(player, options, ready) {
          _classCallCheck(this, CaptionsButton);

          const _this = _possibleConstructorReturn(this, _TextTrackButton.call(this, player, options, ready));
   ...
   */
    ...
    25: [function (_dereq_, module, exports) {
      ...
      const _chaptersTrackMenuItem = _dereq_(26);

      const _chaptersTrackMenuItem2 = _interopRequireDefault(_chaptersTrackMenuItem);
 ...
 */
      const ChaptersButton = (function (_TextTrackButton) {
        ...
        ChaptersButton.prototype.createItems = function createItems() {
          ...
          for (let i = 0; i < tracks.length; i++) {
            ...
            if (track.kind === this.kind_) {
              items.push(new _textTrackMenuItem2.default(this.player_, { track }));
            }
          }
        ...
        ChaptersButton.prototype.createMenu = function createMenu() {
          ...
          if (chaptersTrack && (chaptersTrack.cues === null || chaptersTrack.cues === undefined)) {
            ...
            if (remoteTextTrackEl) {
              remoteTextTrackEl.addEventListener('load', event => _this2.update());
            }
          }
          ...
          if (chaptersTrack && chaptersTrack.cues && chaptersTrack.cues.length > 0) {
            ...
            for (let _i = 0, l = cues.length; _i < l; _i++) {
              const cue = cues[_i];

              const mi = new _chaptersTrackMenuItem2.default(this.player_, {
                cue,
                track: chaptersTrack,
              });
 ...
 */
      const ChaptersTrackMenuItem = (function (_MenuItem) {
 ...
 */
      const DescriptionsButton = (function (_TextTrackButton) {
 ...
 */
      const OffTextTrackMenuItem = (function (_TextTrackMenuItem) {
 ...
 */
      const SubtitlesButton = (function (_TextTrackButton) {
   ...
   */
    ...
    30: [function (_dereq_, module, exports) {
      ...
      const _offTextTrackMenuItem = _dereq_(28);

      const _offTextTrackMenuItem2 = _interopRequireDefault(_offTextTrackMenuItem);
 ...
 */
      const TextTrackButton = (function (_TrackButton) {
 ...
 */
      const TextTrackMenuItem = (function (_MenuItem) {
 ...
 */
      const CurrentTimeDisplay = (function (_Component) {
 ...
 */
      const DurationDisplay = (function (_Component) {
   ...
   */
        ...
        DurationDisplay.prototype.updateContent = function updateContent() {
          ...
          if (duration && this.duration_ !== duration) {
            ...
            const formattedTime = (0, _formatTime2.default)(duration);
 ...
 */
      const RemainingTimeDisplay = (function (_Component) {
   ...
   */
        ...
        RemainingTimeDisplay.prototype.updateContent = function updateContent() {
          if (this.player_.duration()) {
            ...
            const formattedTime = (0, _formatTime2.default)(this.player_.remainingTime());
 ...
 * @class TimeDivider
 */
      const TimeDivider = (function (_Component) {
 ...
 * @class TrackButton
 */
      const TrackButton = (function (_MenuButton) {
        ...
        function TrackButton(player, options) {
          ...
          const updateHandler = Fn.bind(_this, _this.update);

          tracks.addEventListener('removetrack', updateHandler);
          tracks.addEventListener('addtrack', updateHandler);

          _this.player_.on('dispose', () => {
 ...
 * @class VolumeBar
 */
      const VolumeBar = (function (_Slider) {
 ...
 * @class VolumeControl
 */
      const VolumeControl = (function (_Component) {
 ...
 * @class VolumeLevel
 */
      const VolumeLevel = (function (_Component) {
   ...
   */
    ...
    40: [function (_dereq_, module, exports) {
      ...
      const _popup = _dereq_(54);

      const _popup2 = _interopRequireDefault(_popup);

      const _popupButton = _dereq_(53);

      const _popupButton2 = _interopRequireDefault(_popupButton);

      const _muteToggle = _dereq_(11);

      const _muteToggle2 = _interopRequireDefault(_muteToggle);

      const _volumeBar = _dereq_(37);

      const _volumeBar2 = _interopRequireDefault(_volumeBar);
 ...
 */
      const VolumeMenuButton = (function (_PopupButton) {
        ...
        function VolumeMenuButton(player) {
          ...
          const _this = _possibleConstructorReturn(this, _PopupButton.call(this, player, options));
   ...
   */
        ...
        VolumeMenuButton.prototype.createPopup = function createPopup() {
          const popup = new _popup2.default(this.player_, {
            contentElType: 'div',
          });

          const vb = new _volumeBar2.default(this.player_, this.options_.volumeBar);
 ...
 * @class ErrorDisplay
 */
      const ErrorDisplay = (function (_ModalDialog) {
   ...
   */
        function ErrorDisplay(player, options) {
          ...
          const _this = _possibleConstructorReturn(this, _ModalDialog.call(this, player, options));
 ...
 */
      const _inherits = function _inherits(subClass, superClass) {
 ...
 * ```
 */
      const extendFn = function extendFn(superClass) {
        const subClassMethods = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
 ...
 */
      const LoadingSpinner = (function (_Component) {
 ...
 * @class MenuButton
 */
      const MenuButton = (function (_ClickableComponent) {
        ...
        function MenuButton(player) {
          ...
          const _this = _possibleConstructorReturn(this, _ClickableComponent.call(this, player, options));
   ...
   */
        ...
        MenuButton.prototype.createMenu = function createMenu() {
          const menu = new _menu2.default(this.player_);
 ...
 * @class MenuItem
 */
      const MenuItem = (function (_ClickableComponent) {
 ...
 * @class Menu
 */
      const Menu = (function (_Component) {
   ...
   */
        ...
        Menu.prototype.focus = function focus() {
          ...
          const haveTitle = children.length && children[0].className && /vjs-menu-title/.test(children[0].className);
 ...
 */
      ...
      const ModalDialog = (function (_Component) {
 ...
 */
    ...
    51: [function (_dereq_, module, exports) {
      ...
      const _browser = _dereq_(78);

      const browser = _interopRequireWildcard(_browser);
      ...
      const _timeRanges = _dereq_(88);

      const _buffer = _dereq_(79);

      const _stylesheet = _dereq_(87);

      const stylesheet = _interopRequireWildcard(_stylesheet);

      const _fullscreenApi = _dereq_(44);

      const _fullscreenApi2 = _interopRequireDefault(_fullscreenApi);

      const _mediaError = _dereq_(46);

      const _mediaError2 = _interopRequireDefault(_mediaError);

      const _tuple = _dereq_(145);

      const _tuple2 = _interopRequireDefault(_tuple);
      ...
      const _textTrackListConverter = _dereq_(69);

      const _textTrackListConverter2 = _interopRequireDefault(_textTrackListConverter);

      const _modalDialog = _dereq_(50);

      const _modalDialog2 = _interopRequireDefault(_modalDialog);

      const _tech = _dereq_(62);

      const _tech2 = _interopRequireDefault(_tech);

      const _audioTrackList = _dereq_(63);

      const _audioTrackList2 = _interopRequireDefault(_audioTrackList);

      const _videoTrackList = _dereq_(76);

      const _videoTrackList2 = _interopRequireDefault(_videoTrackList);
 ...
 */
      ...
      const Player = (function (_Component) {
        ...
        function Player(tag, options, ready) {
          ...
          const _this = _possibleConstructorReturn(this, _Component.call(this, null, options, ready));
          ...
          if (options.languages) {
            (function () {
              ...
              Object.getOwnPropertyNames(options.languages).forEach((name) => {
     ...
     */
          ...
          // an infinite loop.
          const playerOptionsCopy = (0, _mergeOptions2.default)(_this.options_);
   ...
   */
        ...
        Player.prototype.createEl = function createEl() {
          const el = this.el_ = _Component.prototype.createEl.call(this, 'div');
          const tag = this.tag;
   ...
   */
        ...
        Player.prototype.dimension = function dimension(_dimension, value) {
          const privDimension = `${_dimension}_`;
   ...
   */
        ...
        Player.prototype.updateStyleEl_ = function updateStyleEl_() {
          if (_window2.default.VIDEOJS_NO_DYNAMIC_STYLE === true) {
            const _width = typeof this.width_ === 'number' ? this.width_ : this.options_.width;
            const _height = typeof this.height_ === 'number' ? this.height_ : this.options_.height;
   ...
   */
        ...
        Player.prototype.loadTech_ = function loadTech_(techName, source) {
          ...
          const techOptions = (0, _object2.default)({
            source,
          ...
          let TechComponent = _tech2.default.getTech(techName);
   ...
   */
        ...
        Player.prototype.handleTechWaiting_ = function handleTechWaiting_() {
          ...
          this.one('timeupdate', () => _this3.removeClass('vjs-waiting'));
        };
   ...
   */
        ...
        Player.prototype.requestFullscreen = function requestFullscreen() {
          const fsApi = _fullscreenApi2.default;
   ...
   */
        ...
        Player.prototype.canPlayType = function canPlayType(type) {
          ...
          for (let i = 0, j = this.options_.techOrder; i < j.length; i++) {
            const techName = (0, _toTitleCase2.default)(j[i]);
            let tech = _tech2.default.getTech(techName);
   ...
   */
        ...
        Player.prototype.selectSource = function selectSource(sources) {
          ...
          // current platform
          const techs = this.options_.techOrder.map(_toTitleCase2.default).map(techName => [techName, _tech2.default.getTech(techName) || _component2.default.getComponent(techName)]).filter((_ref) => {
            const techName = _ref[0];
          ...
          // that value.
          const findFirstPassingTechSourcePair = function findFirstPassingTechSourcePair(outerArray, innerArray, tester) {
            let found = void 0;
          ...
          let foundSourceAndTech = void 0;
          const flip = function flip(fn) {
            return function (a, b) {
              return fn(b, a);
            };
          };
          const finder = function finder(_ref2, source) {
            const techName = _ref2[0];
   ...
   */
        ...
        Player.prototype.src = function src(source) {
          ...
          let currentTech = _tech2.default.getTech(this.techName_);
   ...
   */
        ...
        Player.prototype.listenForUserActivity_ = function listenForUserActivity_() {
          let mouseInProgress = void 0;
          let lastMoveX = void 0;
          let lastMoveY = void 0;
          ...
          const handleMouseDown = function handleMouseDown() {
            handleActivity();
            // For as long as the they are touching the device or have their mouse down,
            // we consider them active even if they're not moving their finger or mouse.
            // So we want to continue to update that they are active
   ...
   */
        ...
        Player.prototype.removeRemoteTextTrack = function removeRemoteTextTrack() {
          ...
          const _ref3$track = _ref3.track;


          const track = _ref3$track === undefined ? arguments[0] : _ref3$track;
   ...
   */
        ...
        Player.prototype.toJSON = function toJSON() {
          const options = (0, _mergeOptions2.default)(this.options_);
          const tracks = options.tracks;
   ...
   */
        ...
        Player.prototype.createModal = function createModal(content, options) {
          ...
          const modal = new _modalDialog2.default(this, options);
   ...
   */
        ...
        Player.getTagSettings = function getTagSettings(tag) {
          ...
          if (dataSetup !== null) {
            ...
            const _safeParseTuple = (0, _tuple2.default)(dataSetup || '{}');


            const err = _safeParseTuple[0];


            const data = _safeParseTuple[1];
   ...
   */
        ...
        Player.prototype.flexNotSupported_ = function flexNotSupported_() {
          const elem = _document2.default.createElement('i');
 ...
 */
      ...
      const navigator = _window2.default.navigator;
 ...
 */
      ...
      1: 1, 136: 136, 145: 145, 4: 4, 41: 41, 44: 44, 45: 45, 46: 46, 5: 5, 50: 50, 55: 55, 59: 59, 60: 60, 61: 61, 62: 62, 63: 63, 68: 68, 69: 69, 71: 71, 76: 76, 78: 78, 79: 79, 8: 8, 80: 80, 81: 81, 82: 82, 84: 84, 85: 85, 86: 86, 87: 87, 88: 88, 89: 89, 92: 92, 93: 93,
    }],
    52: [function (_dereq_, module, exports) {
      exports.__esModule = true;

      const _player = _dereq_(51);

      const _player2 = _interopRequireDefault(_player);
 ...
 * @method plugin
 */
      const plugin = function plugin(name, init) {
 ...
 * @class PopupButton
 */
      const PopupButton = (function (_ClickableComponent) {
 ...
 * @class Popup
 */
      const Popup = (function (_Component) {
 ...
 * @class PosterImage
 */
      const PosterImage = (function (_ClickableComponent) {
   ...
   */
    ...
    56: [function (_dereq_, module, exports) {
      ...
      const autoSetup = function autoSetup() {
      ...
      // var mediaEls = vids.concat(audios);
        ...
        const vids = _document2.default.getElementsByTagName('video');
        const audios = _document2.default.getElementsByTagName('audio');
        const mediaEls = [];
        ...
        if (audios && audios.length > 0) {
          for (let _i = 0, _e = audios.length; _i < _e; _i++) {
        ...
        if (mediaEls && mediaEls.length > 0) {
          for (let _i2 = 0, _e2 = mediaEls.length; _i2 < _e2; _i2++) {
            const mediaEl = mediaEls[_i2];
      ...
      if (_document2.default.readyState === 'complete') {
        ...
        Events.one(_window2.default, 'load', () => {
          _windowLoaded = true;
        });
      }

      const hasLoaded = function hasLoaded() {
 ...
 * @class Slider
 */
      const Slider = (function (_Component) {
 ...
 */
   ...
   */
    ...
    59: [function (_dereq_, module, exports) {
      ...
      const _url = _dereq_(90);

      const Url = _interopRequireWildcard(_url);

      const _timeRanges = _dereq_(88);

      const _flashRtmp = _dereq_(58);

      const _flashRtmp2 = _interopRequireDefault(_flashRtmp);
 ...
 */
      ...
      const Flash = (function (_Tech) {
        ...
        function Flash(options, ready) {
          ...
          const _this = _possibleConstructorReturn(this, _Tech.call(this, options, ready));
   ...
   */
        ...
        Flash.prototype.createEl = function createEl() {
          ...
          const flashVars = (0, _object2.default)({
          ...
          const params = (0, _object2.default)({
          ...
          const attributes = (0, _object2.default)({
 ...
 */
    ...
    60: [function (_dereq_, module, exports) {
      ...
      const _templateObject = _taggedTemplateLiteralLoose(['Text Tracks are being loaded from another origin but the crossorigin attribute isn\'t used.\n            This may prevent text tracks from loading.'], ['Text Tracks are being loaded from another origin but the crossorigin attribute isn\'t used.\n            This may prevent text tracks from loading.']);
      ...
      const _tsml = _dereq_(146);

      const _tsml2 = _interopRequireDefault(_tsml);
 ...
 */
      const Html5 = (function (_Tech) {
        ...
        function Html5(options, ready) {
          ...
          if (_this.el_.hasChildNodes()) {
            const nodes = _this.el_.childNodes;
          ...
          trackTypes.forEach((type) => {
            const elTracks = _this.el()[`${type}Tracks`];
            const techTracks = _this[`${type}Tracks`]();
            const capitalType = (0, _toTitleCase2.default)(type);
   ...
   */
        ...
        Html5.prototype.dispose = function dispose() {
          ...
          ['audio', 'video', 'text'].forEach((type) => {
            const capitalType = (0, _toTitleCase2.default)(type);
            const tl = _this2.el_[`${type}Tracks`];
        ...
        Html5.prototype.createEl = function createEl() {
          ...
          if (!el || this.movingMediaElementInDOM === false) {
            ...
            if (el) {
              ...
              const attributes = (0, _mergeOptions2.default)({}, tagAttributes);
        ...
        Html5.prototype.handleLateInit_ = function handleLateInit_(el) {
          ...
          if (el.readyState === 0) {
            const _ret = (function () {
              ...
              const setLoadstartFired = function setLoadstartFired() {
                loadstartFired = true;
              };

              _this3.on('loadstart', setLoadstartFired);

              const triggerLoadstart = function triggerLoadstart() {
   ...
   */
        ...
        Html5.prototype.removeOldTracks_ = function removeOldTracks_(techTracks, elTracks) {
          ...
          for (let _i = 0; _i < removeTracks.length; _i++) {
            const _track = removeTracks[_i];
   ...
   */
        ...
        Html5.prototype.proxyWebkitFullscreen_ = function proxyWebkitFullscreen_() {
          ...
          const beginFn = function beginFn() {
   ...
   */
        ...
        Html5.prototype.supportsFullScreen = function supportsFullScreen() {
          if (typeof this.el_.webkitEnterFullScreen === 'function') {
            const userAgent = _window2.default.navigator && _window2.default.navigator.userAgent || '';
   ...
   */
        ...
        Html5.prototype.addRemoteTextTrack = function addRemoteTextTrack() {
          ...
          const htmlTrackElement = _document2.default.createElement('track');
 ...
 */
      ...
      const track = _document2.default.createElement('track');
 ...
 * @class MediaLoader
 */
      const MediaLoader = (function (_Component) {
        ...
        function MediaLoader(player, options, ready) {
          ...
          const _this = _possibleConstructorReturn(this, _Component.call(this, player, options, ready));
    ...
    62: [function (_dereq_, module, exports) {
      ...
      const _htmlTrackElement = _dereq_(66);

      const _htmlTrackElement2 = _interopRequireDefault(_htmlTrackElement);

      const _htmlTrackElementList = _dereq_(65);

      const _htmlTrackElementList2 = _interopRequireDefault(_htmlTrackElementList);

      const _mergeOptions = _dereq_(86);

      const _mergeOptions2 = _interopRequireDefault(_mergeOptions);

      const _textTrack = _dereq_(72);

      const _textTrack2 = _interopRequireDefault(_textTrack);

      const _textTrackList = _dereq_(70);

      const _textTrackList2 = _interopRequireDefault(_textTrackList);
      ...
      function createTrackHelper(self, kind, label, language) {
        ...
        const track = new _textTrack2.default(options);
 ...
 */
      ...
      const Tech = (function (_Component) {
        _inherits(Tech, _Component);

        function Tech() {
          const options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
          const ready = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : function () {};
   ...
   */
        ...
        Tech.prototype.initTrackListeners = function initTrackListeners() {
          ...
          trackTypes.forEach((type) => {
            const trackListChanges = function trackListChanges() {
              _this3.trigger(`${type}trackchange`);
            };

            const tracks = _this3[`${type}Tracks`]();
   ...
   */
        ...
        Tech.prototype.emulateTextTracks = function emulateTextTracks() {
          ...
          if (!_window2.default.WebVTT && this.el().parentNode !== null && this.el().parentNode !== undefined) {
            (function () {
              const script = _document2.default.createElement('script');
          ...
          const textTracksChanges = function textTracksChanges() {
            updateDisplay();
   ...
   */
        ...
        Tech.prototype.addRemoteTextTrack = function addRemoteTextTrack(options) {
          const track = (0, _mergeOptions2.default)(options, {
            tech: this,
          });

          const htmlTrackElement = new _htmlTrackElement2.default(track);
 ...
 */
   ...
   */
        const deferrable = ['seekable', 'duration'];
   ...
   */
    ...
    63: [function (_dereq_, module, exports) {
      ...
      const _trackList = _dereq_(74);

      const _trackList2 = _interopRequireDefault(_trackList);
 ...
 */
      const disableOthers = function disableOthers(list, track) {
 ...
 */
      ...
      const AudioTrackList = (function (_TrackList) {
        ...
        function AudioTrackList() {
          ...
          const tracks = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
          ...
          if (browser.IS_IE8) {
            ...
            for (const prop in _trackList2.default.prototype) {
              if (prop !== 'constructor') {
                list[prop] = _trackList2.default.prototype[prop];
              }
            }
            for (const _prop in AudioTrackList.prototype) {
    ...
    64: [function (_dereq_, module, exports) {
      ...
      const _trackEnums = _dereq_(73);

      const _track = _dereq_(75);
 ...
 * @class AudioTrack
 */
      const AudioTrack = (function (_Track) {
        ...
        function AudioTrack() {
          ...
          const settings = (0, _mergeOptions2.default)(options, {
            kind: _trackEnums.AudioTrackKind[options.kind] || '',
          });
          // on IE8 this will be a document element
          // for every other browser this will be a normal object
          const track = (_this = _possibleConstructorReturn(this, _Track.call(this, settings)), _this);
          let enabled = false;
    ...
    65: [function (_dereq_, module, exports) {
      ...
      const HtmlTrackElementList = (function () {
        function HtmlTrackElementList() {
          const trackElements = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
    ...
    66: [function (_dereq_, module, exports) {
      ...
      const _eventTarget = _dereq_(42);

      const _eventTarget2 = _interopRequireDefault(_eventTarget);
 ...
 */
      ...
      const HTMLTrackElement = (function (_EventTarget) {
        ...
        function HTMLTrackElement() {
          ...
          const _this = _possibleConstructorReturn(this, _EventTarget.call(this));

          let readyState = void 0;
 ...
 */
      ...
      const TextTrackCueList = (function () {
   ...
   */
        ...
        TextTrackCueList.prototype.setCues_ = function setCues_(cues) {
          ...
          const defineProp = function defineProp(index) {
            if (!(`${index}` in this)) {
 ...
 */
      ...
      const TextTrackDisplay = (function (_Component) {
        ...
        function TextTrackDisplay(player, options, ready) {
          ...
          player.ready(Fn.bind(_this, function () {
            ...
            let firstDesc = void 0;
            let firstCaptions = void 0;

            if (trackList) {
              for (let _i = 0; _i < trackList.length; _i++) {
                const track = trackList[_i];
   ...
   */
        ...
        TextTrackDisplay.prototype.updateForTrack = function updateForTrack(track) {
          ...
          for (let _i2 = 0; _i2 < track.activeCues.length; _i2++) {
          ...
          while (i--) {
            ...
            if (overrides.fontPercent && overrides.fontPercent !== 1) {
              const fontSize = _window2.default.parseFloat(cueDiv.style.fontSize);
 ...
 * @private
 */
      const trackToJson_ = function trackToJson_(track) {
        const ret = ['kind', 'label', 'language', 'id', 'inBandMetadataTrackDispatchType', 'mode', 'src'].reduce((acc, prop, i) => {
          ...
          cues: track.cues && Array.prototype.map.call(track.cues, cue => ({
 ...
 */
      const textTracksToJson = function textTracksToJson(tech) {
        const trackEls = tech.$$('track');

        const trackObjs = Array.prototype.map.call(trackEls, t => t.track);
        const tracks = Array.prototype.map.call(trackEls, (trackEl) => {
        ...
        return tracks.concat(Array.prototype.filter.call(tech.textTracks(), track => trackObjs.indexOf(track) === -1).map(trackToJson_));
      };
 ...
 */
      const jsonToTextTracks = function jsonToTextTracks(json, tech) {
        json.forEach((track) => {
      ...
      exports.default = { textTracksToJson, jsonToTextTracks, trackToJson_ };
    }, {}],
 ...
 * @class TextTrackList
 */
      const TextTrackList = (function (_TrackList) {
        ...
        function TextTrackList() {
          ...
          if (browser.IS_IE8) {
            ...
            for (const _prop in TextTrackList.prototype) {
              if (_prop !== 'constructor') {
 ...
 */
      ...
      const TextTrackSettings = (function (_Component) {
   ...
   */
        ...
        TextTrackSettings.prototype.getValues = function getValues() {
          ...
          const fontPercent = _window2.default.parseFloat(getSelectedOptionValue(this.$('.vjs-font-percent > select')));
   ...
   */
        ...
        TextTrackSettings.prototype.restoreSettings = function restoreSettings() {
          ...
          try {
            const _safeParseTuple = (0, _tuple2.default)(_window2.default.localStorage.getItem('vjs-text-track-settings'));
   ...
   */
    ...
    72: [function (_dereq_, module, exports) {
      ...
      const _textTrackCueList = _dereq_(67);

      const _textTrackCueList2 = _interopRequireDefault(_textTrackCueList);
      ...
      const _xhr = _dereq_(147);

      const _xhr2 = _interopRequireDefault(_xhr);
 ...
 */
      const parseCues = function parseCues(srcContent, track) {
        const parser = new _window2.default.WebVTT.Parser(_window2.default, _window2.default.vttjs, _window2.default.WebVTT.StringDecoder());
        const errors = [];
        ...
        if (errors.length > 0) {
          ...
          errors.forEach(error => _log2.default.error(error));
 ...
 * @param {Track} track track to addcues to
 */
      const loadTrack = function loadTrack(src, track) {
        const opts = {
          uri: src,
        };
        const crossOrigin = (0, _url.isCrossOrigin)(src);

        if (crossOrigin) {
          opts.cors = crossOrigin;
        }

        (0, _xhr2.default)(opts, Fn.bind(this, (err, response, responseBody) => {
          if (err) {
 ...
 */
      ...
      const TextTrack = (function (_Track) {
        ...
        function TextTrack() {
          ...
          let mode = _trackEnums.TextTrackMode[settings.mode] || 'disabled';
          ...
          // on IE8 this will be a document element
          // for every other browser this will be a normal object
          const tt = (_this = _possibleConstructorReturn(this, _Track.call(this, settings)), _this);
          ...
          const cues = new _textTrackCueList2.default(tt.cues_);
          const activeCues = new _textTrackCueList2.default(tt.activeCues_);
          let changed = false;
          ...
          Object.defineProperty(tt, 'activeCues', {
            get: function get() {
              ...
              if (active.length !== this.activeCues_.length) {
                ...
                for (let _i = 0; _i < active.length; _i++) {
 ...
 * };
 */
      const VideoTrackKind = exports.VideoTrackKind = {
 ...
 * };
 */
      const AudioTrackKind = exports.AudioTrackKind = {
        alternative: 'alternative',
 ...
 * };
 */
      const TextTrackKind = exports.TextTrackKind = {
        subtitles: 'subtitles',
        captions: 'captions',
        descriptions: 'descriptions',
        chapters: 'chapters',
 ...
 */
      const TextTrackMode = exports.TextTrackMode = {
        disabled: 'disabled',
        hidden: 'hidden',
        showing: 'showing',
      };
 ...
 * @class TrackList
 */
      const TrackList = (function (_EventTarget) {
        ...
        function TrackList() {
          ...
          let list = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
 ...
 * @class Track
 */
      const Track = (function (_EventTarget) {
 ...
 */
      ...
      const VideoTrackList = (function (_TrackList) {
        ...
        function VideoTrackList() {
          ...
          if (browser.IS_IE8) {
            ...
            for (const _prop in VideoTrackList.prototype) {
              if (_prop !== 'constructor') {
 ...
 * @class VideoTrack
 */
      const VideoTrack = (function (_Track) {
 ...
 * @file browser.js
 */
      const USER_AGENT = _window2.default.navigator && _window2.default.navigator.userAgent || '';
 ...
 * @private
 */
      const IS_IPAD = exports.IS_IPAD = /iPad/i.test(USER_AGENT);

      // The Facebook app's UIWebView identifies as both an iPhone and iPad, so
      // to identify iPhones, we need to exclude iPads.
      // http://artsy.github.io/blog/2012/10/18/the-perils-of-ios-user-agent-sniffing/
      const IS_IPHONE = exports.IS_IPHONE = /iPhone/i.test(USER_AGENT) && !IS_IPAD;
      const IS_IPOD = exports.IS_IPOD = /iPod/i.test(USER_AGENT);
      const IS_IOS = exports.IS_IOS = IS_IPHONE || IS_IPAD || IS_IPOD;

      const IOS_VERSION = exports.IOS_VERSION = (function () {
      ...
      const IS_ANDROID = exports.IS_ANDROID = /Android/i.test(USER_AGENT);
      const ANDROID_VERSION = exports.ANDROID_VERSION = (function () {
      ...
      const IS_OLD_ANDROID = exports.IS_OLD_ANDROID = IS_ANDROID && /webkit/i.test(USER_AGENT) && ANDROID_VERSION < 2.3;
      const IS_NATIVE_ANDROID = exports.IS_NATIVE_ANDROID = IS_ANDROID && ANDROID_VERSION < 5 && appleWebkitVersion < 537;

      const IS_FIREFOX = exports.IS_FIREFOX = /Firefox/i.test(USER_AGENT);
      const IS_EDGE = exports.IS_EDGE = /Edge/i.test(USER_AGENT);
      const IS_CHROME = exports.IS_CHROME = !IS_EDGE && /Chrome/i.test(USER_AGENT);
      const IS_IE8 = exports.IS_IE8 = /MSIE\s8\.0/.test(USER_AGENT);
      const IE_VERSION = exports.IE_VERSION = (function (result) {
        return result && parseFloat(result[1]);
      }(/MSIE\s(\d+)\.\d/.exec(USER_AGENT)));

      const TOUCH_ENABLED = exports.TOUCH_ENABLED = !!('ontouchstart' in _window2.default || _window2.default.DocumentTouch && _document2.default instanceof _window2.default.DocumentTouch);
      const BACKGROUND_SIZE_SUPPORTED = exports.BACKGROUND_SIZE_SUPPORTED = 'backgroundSize' in _document2.default.createElement('video').style;
    }, { 92: 92, 93: 93 }],
 ...
 */
   ...
   */
    ...
    80: [function (_dereq_, module, exports) {
      ...
      const _templateObject = _taggedTemplateLiteralLoose(['Setting attributes in the second argument of createEl()\n                has been deprecated. Use the third argument instead.\n                createEl(type, properties, attributes). Attempting to set ', ' to ', '.'], ['Setting attributes in the second argument of createEl()\n                has been deprecated. Use the third argument instead.\n                createEl(type, properties, attributes). Attempting to set ', ' to ', '.']);
 ...
 */
      function createQuerier(method) {
        return function (selector, context) {
          ...
          const ctx = isEl(context) ? context : _document2.default;
 ...
 */
      function createEl() {
        ...
        const el = _document2.default.createElement(tagName);

        Object.getOwnPropertyNames(properties).forEach((propName) => {
        ...
        Object.getOwnPropertyNames(attributes).forEach((attrName) => {
 ...
 */
      function removeElClass(element, classToRemove) {
        if (element.classList) {
          ...
          element.className = element.className.split(/\s+/).filter(c => c !== classToRemove).join(' ');
        }
 ...
 */
      function findElPosition(el) {
        ...
        const docEl = _document2.default.documentElement;
        const body = _document2.default.body;

        const clientLeft = docEl.clientLeft || body.clientLeft || 0;
        const scrollLeft = _window2.default.pageXOffset || body.scrollLeft;
        const left = box.left + scrollLeft - clientLeft;

        const clientTop = docEl.clientTop || body.clientTop || 0;
        const scrollTop = _window2.default.pageYOffset || body.scrollTop;
 ...
 * @return   {Element|null}
 */
      const $ = exports.$ = createQuerier('querySelector');
 ...
 * @return   {NodeList}
 */
      const $$ = exports.$$ = createQuerier('querySelectorAll');
    }, {
 ...
 */
      function fixEvent(event) {
        ...
        if (!event || !event.isPropagationStopped) {
          (function () {
            const old = event || _window2.default.event;
            ...
            if (event.clientX !== null && event.clientX !== undefined) {
              const doc = _document2.default.documentElement;
              const body = _document2.default.body;
 ...
 */
      ...
      // Don't want to add a cache object through getElData if not needed
        ...
        // Utility function
        const removeType = function removeType(t) {
          data.handlers[t] = [];
 ...
 * @method bind
 */
      const bind = exports.bind = function bind(context, fn, uid) {
 ...
 */
      function formatTime(seconds) {
        const guide = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : seconds;
 ...
 */
      const logByType = exports.logByType = function logByType(type, args) {
        const stringify = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : !!_browser.IE_VERSION && _browser.IE_VERSION < 11;
        ...
        const fn = _window2.default.console && _window2.default.console[type];
 ...
 */
    ...
    87: [function (_dereq_, module, exports) {
      ...
      const createStyleElement = exports.createStyleElement = function createStyleElement(className) {
        const style = _document2.default.createElement('style');
      ...
      const setTextContent = exports.setTextContent = function setTextContent(el, content) {
        if (el.styleSheet) {
 ...
 * @file url.js
 */
      const parseUrl = exports.parseUrl = function parseUrl(url) {
        const props = ['protocol', 'hostname', 'port', 'pathname', 'search', 'hash', 'host'];

        // add the url to an anchor and let the browser parse the URL
        let a = _document2.default.createElement('a');
 ...
 */
      const getAbsoluteURL = exports.getAbsoluteURL = function getAbsoluteURL(url) {
      // Check if absolute URL
        if (!url.match(/^https?:\/\//)) {
        // Convert to absolute URL. Flash hosted off-site needs an absolute URL.
          const div = _document2.default.createElement('div');
 ...
 */
      const getFileExtension = exports.getFileExtension = function getFileExtension(path) {
 ...
 */
      const isCrossOrigin = exports.isCrossOrigin = function isCrossOrigin(url) {
        const winLoc = _window2.default.location;
    ...
    91: [function (_dereq_, module, exports) {
      ...
      const _setup = _dereq_(56);

      const setup = _interopRequireWildcard(_setup);
      ...
      const _plugins = _dereq_(52);

      const _plugins2 = _interopRequireDefault(_plugins);
      ...
      const _audioTrack = _dereq_(64);

      const _audioTrack2 = _interopRequireDefault(_audioTrack);

      const _videoTrack = _dereq_(77);

      const _videoTrack2 = _interopRequireDefault(_videoTrack);
      ...
      const _extend = _dereq_(43);

      const _extend2 = _interopRequireDefault(_extend);

      const _merge2 = _dereq_(131);

      const _merge3 = _interopRequireDefault(_merge2);
 ...
 */
      ...
      131: 131, 147: 147, 42: 42, 43: 43, 5: 5, 51: 51, 52: 52, 56: 56, 62: 62, 64: 64, 72: 72, 77: 77, 78: 78, 80: 80, 81: 81, 82: 82, 83: 83, 85: 85, 86: 86, 87: 87, 88: 88, 90: 90, 92: 92, 93: 93,
    }],
    92: [function (_dereq_, module, exports) {
      (function (global) {
        const topLevel = typeof global !== 'undefined' ? global
          : typeof window !== 'undefined' ? window : {};
        const minDoc = _dereq_(94);
    ...
    95: [function (_dereq_, module, exports) {
      const getNative = _dereq_(111);

      /* Native method references for those with the same name as other `lodash` methods. */
      const nativeNow = getNative(Date, 'now');
 ...
 */
    ...
    96: [function (_dereq_, module, exports) {
      const isObject = _dereq_(124);


      const now = _dereq_(95);
 ...
 */
    ...
    102: [function (_dereq_, module, exports) {
      const createBaseFor = _dereq_(109);
 ...
 */
    ...
    103: [function (_dereq_, module, exports) {
      const baseFor = _dereq_(102);


      const keysIn = _dereq_(130);
 ...
 */
    ...
    104: [function (_dereq_, module, exports) {
      const arrayEach = _dereq_(100);


      const baseMergeDeep = _dereq_(105);


      const isArray = _dereq_(121);


      const isArrayLike = _dereq_(112);


      const isObject = _dereq_(124);


      const isObjectLike = _dereq_(117);


      const isTypedArray = _dereq_(127);


      const keys = _dereq_(129);
 ...
 */
      function baseMerge(object, source, customizer, stackA, stackB) {
        ...
        const isSrcArr = isArrayLike(source) && (isArray(source) || isTypedArray(source));


        const props = isSrcArr ? undefined : keys(source);
        ...
        arrayEach(props || source, (srcValue, key) => {
          ...
          if (isObjectLike(srcValue)) {
            ...
            const isCommon = result === undefined;
    ...
    105: [function (_dereq_, module, exports) {
      const arrayCopy = _dereq_(99);


      const isArguments = _dereq_(120);
      ...
      const isPlainObject = _dereq_(125);


      const isTypedArray = _dereq_(127);


      const toPlainObject = _dereq_(128);
 ...
 */
    ...
    108: [function (_dereq_, module, exports) {
      const bindCallback = _dereq_(107);


      const isIterateeCall = _dereq_(115);


      const restParam = _dereq_(97);
 ...
 */
      function createAssigner(assigner) {
        return restParam((object, sources) => {
          ...
          let length = object == null ? 0 : sources.length;


          let customizer = length > 2 ? sources[length - 2] : undefined;


          const guard = length > 2 ? sources[2] : undefined;


          const thisArg = length > 1 ? sources[length - 1] : undefined;
 ...
 */
    ...
    110: [function (_dereq_, module, exports) {
      const baseProperty = _dereq_(106);
 ...
 */
    ...
    112: [function (_dereq_, module, exports) {
      const getLength = _dereq_(110);


      const isLength = _dereq_(116);
 ...
 */
    ...
    123: [function (_dereq_, module, exports) {
      const isFunction = _dereq_(122);


      const isHostObject = _dereq_(113);
 ...
 */
      ...
      || (!hasOwnProperty.call(value, 'constructor') && (Ctor = value.constructor, typeof Ctor === 'function' && !(Ctor instanceof Ctor)))) {
        ...
        let result;
        if (support.ownLast) {
          baseForIn(value, (subValue, key, object) => {
 ...
 */
      ...
      arrayEach(shadowProps, (key) => {
        for (const tag in nonEnumProps) {
          if (hasOwnProperty.call(nonEnumProps, tag)) {
            const props = nonEnumProps[tag];
 ...
 */
    ...
    && (isArray(object) || isArguments(object) || isString(object)) && length) || 0;
        ...
        const skipErrorProps = support.enumErrorProps && (object === errorProto || object instanceof Error);
        ...
        if (support.nonEnumShadows && object !== objectProto) {
          const tag = object === stringProto ? stringTag : (object === errorProto ? errorTag : objToString.call(object));
    ...
    131: [function (_dereq_, module, exports) {
      const baseMerge = _dereq_(104);


      const createAssigner = _dereq_(108);
 ...
 */
    ...
    135: [function (_dereq_, module, exports) {
      ...
      const keys = _dereq_(141);
      const bind = _dereq_(140);
      const canBeObject = function (obj) {
        return typeof obj !== 'undefined' && obj !== null;
      };
      const hasSymbols = _dereq_(134)();
      ...
      module.exports = function assign(target, source1) {
        ...
        let s; let source; let i; let props; let syms; let value; let
          key;
    ...
    136: [function (_dereq_, module, exports) {
      const defineProperties = _dereq_(137);

      const implementation = _dereq_(135);
      const getPolyfill = _dereq_(143);
      const shim = _dereq_(144);
    ...
    140: [function (_dereq_, module, exports) {
      const implementation = _dereq_(139);
    ...
    147: [function (_dereq_, module, exports) {
      const window = _dereq_(93);
      const once = _dereq_(149);
      const isFunction = _dereq_(148);
      const parseHeaders = _dereq_(152);
      const xtend = _dereq_(153);

      module.exports = createXHR;
      createXHR.XMLHttpRequest = window.XMLHttpRequest || noop;
      createXHR.XDomainRequest = 'withCredentials' in (new createXHR.XMLHttpRequest()) ? createXHR.XMLHttpRequest : window.XDomainRequest;

      forEachArray(['get', 'put', 'post', 'patch', 'head', 'delete'], (method) => {
      ...
      function _createXHR(options) {
        ...
        const headers = xhr.headers = options.headers || {};
    ...
    152: [function (_dereq_, module, exports) {
      const trim = _dereq_(151);


      const forEach = _dereq_(150);
...
(function (root) {
  const vttjs = root.vttjs = {};
  const cueShim = vttjs.VTTCue;
  const regionShim = vttjs.VTTRegion;
  const oldVTTCue = root.VTTCue;
  const oldVTTRegion = root.VTTRegion;
...
(function (global) {
  const _objCreate = Object.create || (function () {
    function F() {}
    return function (o) {
      if (arguments.length !== 1) {
  ...
  const strongRTLChars = [0x05BE, 0x05C0, 0x05C3, 0x05C6, 0x05D0, 0x05D1,
  ...
  function determineBidi(cueDiv) {
    ...
    while ((text = nextTextNode(nodeStack))) {
      for (let i = 0; i < text.length; i++) {
        ...
        for (let j = 0; j < strongRTLChars.length; j++) {
  ...
  function BoxPosition(obj) {
    ...
    let lh; let height; let width; let
      top;
    if (obj.div) {
  ...
  WebVTT.processCues = function (window, cues, overlay) {
    ...
    const fontSize = Math.round(containerBox.height * FONT_SIZE_PERCENT * 100) / 100;
    const styleOptions = {
  ...
  WebVTT.Parser.prototype = {
    ...
    parse(data) {
      ...
      function parseRegion(input) {
        ...
        // specified.
        if (settings.has('id')) {
          const region = new (self.vttjs.VTTRegion || self.window.VTTRegion)();
